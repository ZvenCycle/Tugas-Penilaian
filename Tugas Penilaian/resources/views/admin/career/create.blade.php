...
<head>
    ...
    <title>Admin - Tambah Lowongan Kerja</title>
            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><i class="fas fa-chevron-right"></i></li>
                        <li>
                            <a class="active" href="{{ route('admin.career.create') }}">Tambah Lowongan</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="form-container">
                <form action="{{ route('admin.career.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Upload foto untuk lowongan kerja (opsional). Format yang didukung: JPG, PNG, GIF. Maksimal 2MB.</small>
                        @error('photo')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="requirements" name="requirements" rows="5" required>{{ old('requirements') }}</textarea>
                        @error('requirements')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
